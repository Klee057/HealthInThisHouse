 ...
 */
public class CalorieDBSearch extends Fragment implements MyItemRecyclerViewAdapter2.OnNoteListener {

    private String TAG = "CalorieDBSearch";
    ...
    FragmentCalorieDbSearchListBinding binding;

    FirebaseFirestore db = FirebaseFirestore.getInstance();

    public CalorieDBSearch() {
        //empty constructor
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCalorieDbSearchListBinding.inflate(inflater, container, false);
...
//        }
    ...
    private void setAdapter() {
        adapter = new MyItemRecyclerViewAdapter2(dbitemsList, this);
    ...
    public void onNoteClick(int position) {
        ...
        Log.d(TAG, "onNoteClick: A Calorie DB Search card is clicked - itemName: " + itemName + "; itemCalories: " + itemCalories);
    }
