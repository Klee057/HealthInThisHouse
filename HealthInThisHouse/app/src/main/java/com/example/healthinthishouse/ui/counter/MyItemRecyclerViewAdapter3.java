...
import com.example.healthinthishouse.databinding.FragmentCalorieRecipeBinding;

import java.util.ArrayList;
import java.util.List;

public class MyItemRecyclerViewAdapter3 extends RecyclerView.Adapter<MyItemRecyclerViewAdapter3.MyViewHolder>{

    private ArrayList<itemData> dbitemsList;
    private OnNoteListener mOnNoteListener;

    public MyItemRecyclerViewAdapter3(ArrayList<itemData> items, OnNoteListener onNoteListener) {
        dbitemsList = items;
    ...
    @Override
    public MyItemRecyclerViewAdapter3.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_calorie_recipe, parent, false);
